...
- 运行 Windows 10（[已更新到版本 1903 或更高版本](ms-settings:windowsupdate)，对于 x64 系统则是内部版本 18362 或更高版本）。
   - 如果你在使用 Windows 10 版本 1903 或 1909，请确保你的次要版本号至少为 1049。 请参阅[此处的完整疑难解答说明](https://docs.microsoft.com/windows/wsl/troubleshooting#im-on-windows-10-version-1903-and-i-still-do-not-see-options-for-wsl-2)
